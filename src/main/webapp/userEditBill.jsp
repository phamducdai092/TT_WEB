...
<div class="container">
    <div>
        ...
        <a class="back-cta" href="<%= request.getContextPath()%>/history-bill">Quản Lý Đơn Hàng</a>
    </div>
    <div class="title">Chỉnh sửa đơn hàng</div>
    <c:set var="user" value="${sessionScope.user}"/>
    <c:set var="userId" value="${sessionScope.userId}"/>
    <div class="user-wraper">
        <form method="get" action="changeInfoUser" class="left">
            <input value="${user.getId()}" hidden="hidden" name="userId">
            <p class="user-header">Thông tin đơn hàng</p>
